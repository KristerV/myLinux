...
function rec720pulse {
    ...
    ffmpeg -f alsa -i pulse -acodec pcm_s16le -f x11grab -s `xdpyinfo | grep 'dimensions:'|awk '{print $2}'` -r 25 -i :0.0 -b 50000k -minrate 20000k -maxrate 80000k -strict -2 -b:a 320k -vcodec mpeg4 screencast_$datetime.mp4 2> ~/.tmp/error.txt
}
